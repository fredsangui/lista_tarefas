	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
                ...
                function apagar_usuario(identificador){
                    $.ajax({
                        url: 'apaga_usuario.php',
                        method: 'POST',
	    	...
	    	<div class="col-md-10">
	    		<div class="panel panel-default">
					<div class="panel-body">
						<form class="input-group" id = "form_busca" method="post">
							<input type="text" class="form-control" placeholder='Nome do Usuário' name="buscar" id="id_buscar">
